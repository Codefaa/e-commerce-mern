...
function Contacto() {
    ...
    return(
        <section className='contacto-seccion'>
            ...
            <p className='contacto-parrafo'>Vea nuestras <a className='contacto-enlace' href="https://codefaa.github.io/portafolio-react/" rel="noreferrer">preguntas frecuentes.</a></p>
